...
#error Unsupported PIC32MZ Ex class processor
...
#if (__PIC32_FEATURE_SET__ >= 500) && (__PIC32_FEATURE_SET__ < 800)
...
#error Unsupported PIC32MX class processor
